...
namespace Trial1_Movement_Classes_COMPROGPROJ
{
    internal class Ogre
    {
        public string[] Skills = { "Bash", "Bestial Roar", "Bestial Vitality", "Bestial Sling" };
        ...
        public int[] Damage(int chosenAttack, int MobStrength, int playerArmor, int playerMR, int playerLuck, int playerEvasion, int[] playerDebuffs, int[] mobBuffs)
        {
            ...
            if (chosenAttack == 1)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    ...
                    {
                        damage[1] = (int)(((20 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.5f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 0;
                    }
                    ...
                    {
                        damage[1] = (int)(((20 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.5f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 0;
                    }
            ...
            else if (chosenAttack == 2)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    if (random.Next(1, 101) >= 50 - (playerLuck * .6))
                    {
                        damage[1] = (int)(((15 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.3f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 70;
                        damage[3] = 100;
                        damage[7] = 1;
                    }
                    ...
                    {
                        damage[1] = (int)(((15 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.3f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 70;
                        damage[3] = 100;
                        damage[7] = 1;
                    }
