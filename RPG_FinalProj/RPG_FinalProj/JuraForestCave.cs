...
{
    public partial class JuraForestCave : Form
    {
        private readonly LocItems _items;


        int[,] obstacles = new int[15, 4];
        PictureBox[] obstacle = new PictureBox[15];
        ...
        private void JuraForestCave_Load(object sender, EventArgs e)
        {
            item[0] = item1;
            item[1] = item2;
            item[2] = item3;
        ...
        private void JuraForestCave_KeyDown_1(object sender, KeyEventArgs e)
        {
