...
{
    internal class Werewolf
    {
        public string[] Skills = { "Dark Slashes", "Pounce", "Wolf's Frenzy", "Mark of Death" };
        ...
        public int[] Damage(int chosenAttack, int MobStrength, int playerArmor, int playerMR, int playerLuck, int playerEvasion, int[] playerDebuffs, int[] mobBuffs)
        {
            ...
            if (chosenAttack == 1)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    ...
                    {
                        damage[1] = (int)(((15 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.4f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 0;
                    }
                    ...
                    {
                        damage[1] = (int)(((15 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.4f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 0;
                    }
            ...
            else if (chosenAttack == 2)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    if (random.Next(1, 101) >= 50 - (playerLuck * .6))
                    {
                        damage[1] = (int)(((10 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.8f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 1;
                    }
                    ...
                    {
                        damage[1] = (int)(((10 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.8f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 1;
                    }
            ...
            else if (chosenAttack == 3)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    ...
                    {
                        damage[1] = (int)(((10 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.4f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 2;
                    }
                    ...
                    {
                        damage[1] = (int)(((10 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.4f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 2;
                    }
            ...
            else if (chosenAttack == 4)
            {
                if (random.Next(1, 101) >= 50 - (playerLuck * .6))
                {
                    damage[1] = (int)(((20 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                    damage[2] = 30;
                    damage[3] = 100;
                    damage[7] = 3;
                }
                ...
                {
                    damage[1] = (int)(((20 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                    damage[2] = 30;
                    damage[3] = 100;
                    damage[7] = 3;
                }
