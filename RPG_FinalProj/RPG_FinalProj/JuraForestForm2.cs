...
{
    public partial class JuraForestForm2 : Form
    {
            ...
            for (int i = 0; i < moblocation.GetLength(0); i++)
            {
                   ...
                   (newPosition[3] >= moblocation[i, 3] && newPosition[1] <= moblocation[i, 3])))
                {
                    if (mob[i] == "TeleportLeft")
                    {
                        ...
                        Program.items.location[0] = 1223;
                        Program.items.location[1] = 489;
                        JuraForestForm1 JFF = new JuraForestForm1();
                        this.Hide();
                        JFF.ShowDialog();
                        this.Close();
        ...
        private void JuraForestForm2_Load(object sender, EventArgs e)
        {
            item[0] = item1;
            item[1] = item2;
            item[2] = item3;
