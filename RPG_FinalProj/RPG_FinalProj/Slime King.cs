...
{
    internal class Slime_King
    {
        public string[] Skills = { "Acidic Splash", "Body Slam", "Goo Blaze", "Corrosive Rain" };
        ...
        public int[] Damage(int chosenAttack, int MobStrength, int playerArmor, int playerMR, int playerLuck, int playerEvasion, int[] playerDebuffs, int[] mobBuffs)
        {
            ...
            else if (chosenAttack == 2)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    if (random.Next(1, 101) >= 50 - (playerLuck * .6))
                    {
                        damage[1] = (int)(((25 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 3.5f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 1;
                    }
                    ...
                    {
                        damage[1] = (int)(((25 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 3.5f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 1;
                    }
            ...
            else if (chosenAttack == 3)
            {
                if (random.Next(1, 101) >= (playerEvasion + (playerLuck * .6)) / 2)
                {
                    ...
                    {
                        damage[1] = (int)(((15 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.8f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 2;
                    }
                    ...
                    {
                        damage[1] = (int)(((15 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 2.8f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                        damage[2] = 100;
                        damage[3] = 100;
                        damage[7] = 2;
                    }
            ...
            else if (chosenAttack == 4)
            {
                if (random.Next(1, 101) >= 50 - (playerLuck * .6))
                {
                    damage[1] = (int)(((20 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 3f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)) * 1.5);
                    damage[2] = 50;
                    damage[3] = 100;
                    damage[4] = 50;
                    damage[7] = 3;
                ...
                {
                    damage[1] = (int)(((20 + (MobStrength * (1 + (mobBuffs[0] / 100f))) * 3f) * ((100 - (playerArmor * (playerDebuffs[0] / 100f))) / 100f)));
                    damage[2] = 50;
                    damage[3] = 100;
                    damage[4] = 50;
                    damage[7] = 3;
